...
The Update Wave is a process that propagates changes through the graph starting when a claim receives an update to its confidence.
...
- If the outgoing connector is a Relevance Connector:
  ...
  - **Junction Aggregator Adjust**:
    - If visible, the relevance aggregator (progressively?/uniformly?) adjusts to the new confidence score.
...
- **Claim Aggregator Adjust**: The claim aggregator (progressively?/uniformly?) adjusts to the new confidence score.
