...
- The default launcher now lives at the Software root through `pnpm run command-center:dev`.
...
- Current-video actions, episode rendering, and Studio launch now run through the command center instead of root-level convenience scripts.
