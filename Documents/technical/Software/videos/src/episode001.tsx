...
import { GraphEvents, GraphView, type GraphActionEntry } from "./shared/v2/GraphView.tsx";
import { buildTimelineTimes, wait } from "./shared/timeline.ts";

const EPISODE_ID = "Episode001";
const EPISODE_TITLE = "Episode 001";
...
const episode001Debate = normalizeDebateScores(createEpisode001Debate());
	...
	return (
		<EpisodeTemplate>
			<Fade
				...
				name="Graph Fade"
			>
				<GraphView debate={episode001Debate} siblingOrderingMode="preserve-input" debugTimeline>
...
function createEpisode001Debate(): Debate {
	const scoreIds = {
		main: asScoreId("score:main"),
	} as const;

	return newDebate({
		id: "debate:episode-001" as Debate["id"],
		name: "Episode 001 graph",
		description: "Reason Tracker graph for Episode001.",
		mainClaimId: claimIds.main,
		claims: {
			[claimIds.main]: newClaim({
				id: claimIds.main,
				content: "Fictional City benefits overall from converting Elm Street to pedestrian-only use.",
				side: "proMain",
			}),
		},
		connectors: {},
