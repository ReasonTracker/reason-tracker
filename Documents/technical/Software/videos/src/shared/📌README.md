...
- the [Episode JSON authoring](./Episode%20Script%20Authoring.md) guide for human and AI script authors
...
- Update [Episode JSON authoring](./Episode%20Script%20Authoring.md) whenever the script schema, supported options, defaults, or compiler behavior changes.
