...
- For approval requests about guarded technical areas, include the recommended path and enough technical detail to support a decision in one pass.
- At minimum, name the affected type or flow changes and any contract changes, including modified individual contracts, new or modified operations, payload changes, sequencing changes, and any affected docs or consumers.
