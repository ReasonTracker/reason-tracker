...
Communities often face hard decisions, and disagreements can seem impossible to resolve. In most discussions, people share reasons but do not show how strongly each one is supported compared with others, so hidden assumptions lead to disagreement. In complex debates, people cannot hold every reason in mind at once, so attention shifts and conclusions drift apart.
...
- Show how scores change over time, without implying any score is final.
- Prioritize clarity and explainability over advanced automation.
